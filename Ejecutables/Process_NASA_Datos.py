#=================================================================
#                Process_NASA_Datos.py c骴igo de controlar
#                Process_NASA_Datos.py Terminal script
#-----------------------------------------------------------------
#(Espanol)
#   Script para interactuar con el contenido de pit髇 de la NASA
...
for Basin in Basins:
    for Year in Years:
        ...
        nasa.Process_MODIS(Package,Basin,Year) # 对MODIS数据裁剪+重采样
        end=time.time()
